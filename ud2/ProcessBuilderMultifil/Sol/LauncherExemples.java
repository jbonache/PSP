...
class Launcher implements Runnable {
    ...
    Launcher(String ordre, String color, Terminal terminal) {
        this.ordre = ordre;
        this.color = color;
...
public class LauncherExemples {
    ...
    static Terminal terminal; // No cal ni donar-li valor...

    public static void main(String[] args) {
        try {
            terminal=new Terminal();
            // Creamos algunos objetos de ejemplo
            Launcher l = new Launcher("ps aux", "\u001B[31m", terminal);
            Launcher l2 = new Launcher("ls -l /", "\u001B[32m", terminal);
